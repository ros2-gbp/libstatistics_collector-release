## libstatistics_collector (rolling) - 3.0.0-1

The packages in the `libstatistics_collector` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling libstatistics_collector` on `Fri, 08 May 2026 20:50:06 -0000`
...
## libstatistics_collector (rolling) - 2.1.2-1

The packages in the `libstatistics_collector` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling libstatistics_collector` on `Thu, 30 Apr 2026 17:42:03 -0000`
...
## libstatistics_collector (lyrical) - 2.1.2-1

The packages in the `libstatistics_collector` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical libstatistics_collector` on `Thu, 30 Apr 2026 17:40:07 -0000`
...
## libstatistics_collector (rolling) - 2.1.1-1

The packages in the `libstatistics_collector` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling libstatistics_collector` on `Tue, 01 Jul 2025 16:47:00 -0000`
...
## libstatistics_collector (rolling) - 2.1.0-1

The packages in the `libstatistics_collector` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release libstatistics_collector -r rolling` on `Fri, 25 Apr 2025 20:23:59 -0000`
...
## libstatistics_collector (jazzy) - 1.7.4-1

The packages in the `libstatistics_collector` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy libstatistics_collector` on `Wed, 18 Dec 2024 05:27:30 -0000`
...
## libstatistics_collector (humble) - 1.3.4-1

The packages in the `libstatistics_collector` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble -y libstatistics_collector` on `Mon, 25 Nov 2024 17:36:35 -0000`
...
## libstatistics_collector (rolling) - 2.0.1-1

The packages in the `libstatistics_collector` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling libstatistics_collector` on `Wed, 20 Nov 2024 16:48:29 -0000`
...
## libstatistics_collector (iron) - 1.5.3-1

The packages in the `libstatistics_collector` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron libstatistics_collector` on `Fri, 08 Nov 2024 20:13:16 -0000`
...
## libstatistics_collector (rolling) - 2.0.0-1
